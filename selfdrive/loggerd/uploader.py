...
def is_on_hotspot():
  try:
    ...
    is_entune = result.startswith('10.0.0.') # limits uploading
...
class Uploader():
  def __init__(self, dongle_id, root):
    ...
    self.immediate_priority = {"qcamera.ts": 0} # limits uploading
    self.high_priority = {"qcamera.ts": 0} # limits uploading
